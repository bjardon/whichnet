...
- [x] Menu bar and panel share chosen SF Symbols for each interface type (`wifi`, `personalhotspot`, `app.connected.to.app.below.fill`, `antenna.radiowaves.left.and.right`, `network.badge.shield.half.filled`, `network`, `xmark.circle`)
...
- [x] Personal Hotspot (iPhone Wi-Fi/USB/Bluetooth tethering) uses `personalhotspot` and is labeled distinct from regular Wi-Fi
